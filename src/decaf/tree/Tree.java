...
public abstract class Tree {
	...
	/**
	 * Shallow copy keyword, of type Scopy
	 */
	public static final int SCOPY = PRINT + 1;

	/**
	 * guarded if stmt, of type Guarded
	 */
	public static final int GUARD = SCOPY + 1;

	/**
	 * Auto detect type, of type Var
	 */
	public static final int VAR = GUARD + 1;

	/**
	 * Binary op ++ for concat, of type Binary
	 */
	public static final int CONCAT = VAR + 1;

	/**
	 * Binary op %% for array init, of type Binary
	 */
	public static final int AINIT = CONCAT + 1;

	/**
	 * Binary op : for array range, of type Binary
	 */
	public static final int RANGE = AINIT + 1;

	/**
	 * Binary op [] for array ref, of type Binary
	 */
	public static final int ARRAYREF = RANGE + 1;

	/**
	 * Binary op [] for array ref, of type Binary
	 */
	public static final int DYNACCESS = ARRAYREF + 1;

	/**
	 * Array comp syntax, of type ArrayComp
	 */
	public static final int ARRAYCOMP = DYNACCESS + 1;

	/**
	 * foreach statement, of type ForeachLoop
	 */
	public static final int FOREACH = ARRAYCOMP + 1;

	/**
	 * tag for default expr, of tyep DefaultExpr
	 */
	public static final int DEFAULTEXPR = FOREACH + 1;
	...
	public static final int ARRAYCONST = STRING + 1;
	...
	public static class ForeachLoop extends Tree {
		...
		public ForeachLoop(Tree boundVariable, Expr indexExpr, Expr boolExpr, Tree loopStmt, Location loc) {
			super(FOREACH, loc);
	...
	public static class ArrayComp extends Expr {
		...
		public ArrayComp(Expr generExpr, String name, Expr indexExpr, Expr boolExpr, Location loc) {
			super(ARRAYCOMP, loc);
	...
	public static class Guard extends Tree {
		...
		public Guard(List<Expr> exprList, List<Tree> stmtList, Location loc) {
			super(GUARD, loc);
